const portfoliosDatas = [
  {
    ...
    desc: `Halaman Personal is a website builder (web) application which allows its users to provide information about them. The website that generated by HalamanPersonal is simillar to online CV, but with style and more interactive, and also simillar to portfolio/personal website.
