const portfoliosDatas = [
  ...
  },
  {
    ...
    role: "Back-end Developer",
    type: "Web Application / Website Builder",
    desc: `Halaman Personal is a website builder (web) application which allows its users to provide information about them. The website that generated by HalamanPersonal is simillar to online CV, but with style and more interactive, and also simillar to portfolio/personal website.</br>
    </br>
    This app is consist of three services.
    </br>
    </br>
    First, halamanpersonal.my.id is for client-side (end-user do almost everything here).</br>
    Second, halamanpersonal-backend.herokuapp.com is for backend services and serving API.</br>
    Third, halamanpersonal-images.my.id is for image hosting.</br>
    </br>
    ...
    tools: "React, Next.js, Laravel, PostgreSQL",
